...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 181.6755319148939; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2407.200797872344; // x position of the perpendicular encoder (in tick units)
    }
